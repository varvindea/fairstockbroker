...
function CalcMegaLink({ name, icon }: { name: string; icon: string }) {
  const href = calculatorHref(name)
  return isNativeCalculator(name)
    ? <Link to={href} className="mega-link"><span className="ml-ico">{icon}</span> {name}</Link>
    : <a href={href} className="mega-link"><span className="ml-ico">{icon}</span> {name}</a>
}

function CalcMobLink({ name, icon, onClick }: { name: string; icon: string; onClick: () => void }) {
  const href = calculatorHref(name)
  return isNativeCalculator(name)
    ? <Link to={href} onClick={onClick}>{icon} {name}</Link>
    : <a href={href} onClick={onClick}>{icon} {name}</a>
}
    ...
    <>
            ...
            <div className="mega-drop">
              <div className="mega-inner cols-4">
                <div className="mega-col">
                  ...
                  <CalcMegaLink name="SIP Calculator" icon="📈" />
                  <CalcMegaLink name="Step Up SIP" icon="⬆️" />
                  <CalcMegaLink name="Lumpsum Calculator" icon="💰" />
                  <CalcMegaLink name="SWP Calculator" icon="💸" />
                </div>
                <div className="mega-col">
                  <div className="mega-col-head">🏦 Fixed Income</div>
                  <CalcMegaLink name="FD Calculator" icon="🏛️" />
                  <CalcMegaLink name="RD Calculator" icon="📅" />
                  <CalcMegaLink name="EMI Calculator" icon="🏠" />
                  <CalcMegaLink name="PPF Calculator" icon="🏛️" />
                  <CalcMegaLink name="NPS Calculator" icon="👶" />
                </div>
                <div className="mega-col">
                  <div className="mega-col-head">📊 Analytics</div>
                  <CalcMegaLink name="CAGR Calculator" icon="📊" />
                  <CalcMegaLink name="Compound Interest" icon="♾️" />
                  <CalcMegaLink name="Rule of 72" icon="72️⃣" />
                  <CalcMegaLink name="Goal Planner" icon="🎯" />
      ...
      <div className={`mob-nav${mobOpen ? ' open' : ''}`}>
        ...
        <div className={`mob-acc-panel${accOpen==='calc' ? ' open' : ''}`}>
          ...
          <CalcMobLink name="SIP Calculator" icon="📈" onClick={closeNav} />
          <CalcMobLink name="Step Up SIP" icon="⬆️" onClick={closeNav} />
          <CalcMobLink name="Lumpsum Calculator" icon="💰" onClick={closeNav} />
          <CalcMobLink name="FD Calculator" icon="🏛️" onClick={closeNav} />
          <CalcMobLink name="CAGR Calculator" icon="📊" onClick={closeNav} />
          <CalcMobLink name="Compound Interest" icon="♾️" onClick={closeNav} />
        </div>
